...
const App = () => {
  ...
  const topicsData = {
    ...
    'A1-Life': [
      { en: 'birth', phonetic: '|bɜːθ|', az: 'doğum' },
      { en: 'be born', phonetic: '|bɪ bɔːn|', az: 'doğulmaq' },
      { en: 'live', phonetic: '|lɪv|', az: 'yaşamaq' },
      { en: 'death', phonetic: '|deθ|', az: 'ölüm' },
      { en: 'dead', phonetic: '|ded|', az: 'ölü' },
      { en: 'die', phonetic: '|daɪ|', az: 'ölmək' },
      { en: 'birthday', phonetic: '|ˈbɜːθdeɪ|', az: 'ad günü' },
      { en: 'baby', phonetic: '|ˈbeɪbɪ|', az: 'körpə' },
      { en: 'teenager', phonetic: '|ˈtiːneɪdʒə|', az: 'yeniyetmə' },
      { en: 'young', phonetic: '|jʌŋ|', az: 'cavan' },
      { en: 'youth', phonetic: '|juːθ|', az: 'gənclik' },
      { en: 'adult', phonetic: '|ˈædʌlt|', az: 'yetkin' },
      { en: 'mature', phonetic: '|məˈtʃʊə|', az: 'yetkin' },
      { en: 'grow up', phonetic: '|ɡrəʊ ʌp|', az: 'böyümək' },
      { en: 'middle-aged', phonetic: '|mɪdəlˈeɪdʒd|', az: 'ortayaşlı' },
      { en: 'old', phonetic: '|əʊld|', az: 'qoca, yaşlı; köhnə' },
      { en: 'retired', phonetic: '|rɪˈtaɪəd|', az: 'təqaüdə çıxmış' },
      { en: 'fall in love (with)', phonetic: '|fɔːl ɪn lʌv|', az: 'aşiq olmaq, vurulmaq' },
      { en: 'get engaged (to)', phonetic: '|ɡet ɪnˈɡeɪdʒd|', az: 'nişanlanmaq' },
      { en: 'get married (to)', phonetic: '|ɡet ˈmærɪd|', az: 'evlənmək, kəbin kəsdirmək' },
      { en: 'get separated', phonetic: '|ɡet ˈsepəreɪtɪd|', az: 'ayrılmaq' },
      { en: 'break up', phonetic: '|ˈbreɪk ʌp|', az: 'ayrılmaq' },
      { en: 'get divorced (from)', phonetic: '|ɡet dɪˈvɔːst|', az: 'boşanmaq' },
      { en: 'single', phonetic: '|ˈsɪŋɡ(ə)l|', az: 'subay' },
      { en: 'engaged (to)', phonetic: '|ɪnˈɡeɪdʒd|', az: 'nişanlı' },
      { en: 'married (to)', phonetic: '|ˈmærɪd|', az: 'evli' },
      { en: 'separated', phonetic: '|ˈsepəreɪtɪd|', az: 'ayrı' },
      { en: 'divorced (from)', phonetic: '|dɪˈvɔːst|', az: 'boşanmış' },
      { en: 'widowed', phonetic: '|ˈwɪdəʊd|', az: 'dul' },
      { en: 'fiancé', phonetic: '|fɪˈɒnseɪ|', az: 'nişanlı (oğlan)' },
      { en: 'fiancée', phonetic: '|fɪˈɒnseɪ|', az: 'nişanlı (qız)' },
      { en: 'marriage', phonetic: '|ˈmærɪdʒ|', az: 'evlilik, nigah, kəbin' },
      { en: 'wedding', phonetic: '|ˈwedɪŋ|', az: 'toy' },
      { en: 'bride', phonetic: '|braɪd|', az: 'gəlin' },
      { en: 'groom', phonetic: '|ɡruːm|', az: 'bəy' },
      { en: 'honeymoon', phonetic: '|ˈhʌnɪmuːn|', az: 'bal ayı' },
    ],
    'A1-Music': [
      { en: 'quiet', phonetic: '|ˈkwaɪət|', az: 'sakit' },
      { en: 'loud', phonetic: '|laʊd|', az: 'yüksək səsli' },
      { en: 'listen', phonetic: '|ˈlɪs(ə)n|', az: 'dinləmək' },
      { en: 'hear', phonetic: '|hɪə|', az: 'eşitmək' },
      { en: 'dance', phonetic: '|dɑːns|', az: 'rəqs etmək' },
      { en: 'enjoy', phonetic: '|ɪnˈdʒɔɪ|', az: 'həzz almaq' },
      { en: 'musician', phonetic: '|mjuːˈzɪʃ(ə)n|', az: 'musiqiçi' },
      { en: 'music instrument', phonetic: '|ˈmjuːzɪk ˈɪnstrʊm(ə)nt|', az: 'musiqi aləti' },
      { en: 'piece of music', phonetic: '|piːs ɒv ˈmjuːzɪk|', az: 'musiqi parçası' },
      { en: 'piano', phonetic: '|pɪˈænəʊ|', az: 'piano' },
      { en: 'play', phonetic: '|pleɪ|', az: 'ifa etmək, çalmaq' },
      { en: 'play the piano', phonetic: '|pleɪ ðiː pɪˈænəʊ|', az: 'piano çalmaq' },
      { en: 'guitar', phonetic: '|ɡɪˈtɑː|', az: 'gitara' },
      { en: 'play the guitar', phonetic: '|pleɪ ðiː ɡɪˈtɑː|', az: 'gitara çalmaq' },
      { en: 'violin', phonetic: '|vaɪəˈlɪn|', az: 'skripka' },
      { en: 'clarinet', phonetic: '|ˌklær.ɪˈnɛt|', az: 'klarnet' },
      { en: 'cello', phonetic: '|ˈtʃeləʊ|', az: 'violonçel' },
      { en: 'flute', phonetic: '|fluːt|', az: 'fleyta' },
      { en: 'drum', phonetic: '|drʌm|', az: 'baraban' },
      { en: 'classical', phonetic: '|ˈklæsɪk(ə)l|', az: 'klassik' },
      { en: 'folk', phonetic: '|fəʊk|', az: 'xalq' },
      { en: 'song', phonetic: '|sɒŋ|', az: 'mahnı' },
      { en: 'sing', phonetic: '|sɪŋ|', az: 'oxumaq' },
      { en: 'singer', phonetic: '|ˈsɪŋə|', az: 'müğənni' },
      { en: 'sound', phonetic: '|saʊnd|', az: 'səs' },
      { en: 'compose', phonetic: '|kəmˈpəʊz|', az: 'bəstələmək' },
      { en: 'composer', phonetic: '|kəmˈpəʊzə|', az: 'bəstəkar' },
      { en: 'orchestra', phonetic: '|ˈɔːkɪstrə|', az: 'orkestr' },
      { en: 'conductor', phonetic: '|kənˈdʌktə|', az: 'dirijor' },
      { en: 'symphony', phonetic: '|ˈsɪmf(ə)nɪ|', az: 'simfoniya' },
      { en: 'music note', phonetic: '|ˈmjuːzɪk nəʊt|', az: 'musiqi notu' },
      { en: 'talent', phonetic: '|ˈtælənt|', az: 'istedad' },
      { en: 'talented', phonetic: '|ˈtæləntɪd|', az: 'istedadlı' },
      { en: 'ability', phonetic: '|əˈbɪlɪtɪ|', az: 'bacarıq, qabiliyyət' },
      { en: 'album', phonetic: '|ˈælbəm|', az: 'albom' },
      { en: 'voice', phonetic: '|vɔɪs|', az: 'səs' },
      { en: 'band', phonetic: '|bænd|', az: 'qrup' },
      { en: 'concert', phonetic: '|ˈkɒnsət|', az: 'konsert' },
      { en: 'genre', phonetic: '|ˈʒɒnrə|', az: 'janr' },
      { en: 'rhythm', phonetic: '|ˈrɪð(ə)m|', az: 'ritm' },
      { en: 'speaker', phonetic: '|ˈspiːkə|', az: 'səsucaldan' },
      { en: 'turn up', phonetic: '|ˈtɜːn ʌp|', az: 'səsi çoxaltmaq' },
      { en: 'turn down', phonetic: '|tɜːn daʊn|', az: 'səsi azaltmaq' },
    ],
    'A1-Describing People': [
      { en: 'appearance', phonetic: '|əˈpɪər(ə)ns|', az: 'görünüş' },
      { en: 'nice', phonetic: '|naɪs|', az: 'gözəl, qəşəng, göyçək, xoş, sevimli' },
      { en: 'pretty', phonetic: '|ˈprɪtɪ|', az: 'gözəl, qəşəng, göyçək' },
      { en: 'beautiful', phonetic: '|ˈbjuːtɪfʊl|', az: 'gözəl, qəşəng, göyçək' },
      { en: 'gorgeous', phonetic: '|ˈɡɔːdʒəs|', az: 'ecazkar' },
      { en: 'attractive', phonetic: '|əˈtræktɪv|', az: 'cazibədar' },
      { en: 'handsome', phonetic: '|ˈhæns(ə)m|', az: 'yaraşıqlı' },
      { en: 'good-looking', phonetic: '|ˌɡʊdˈlʊkɪŋ|', az: 'xoş görünüşlü' },
      { en: 'average-looking', phonetic: '|ˈæv(ə)rɪdʒ ˈlʊkɪŋ|', az: 'orta görünüşlü' },
      { en: 'plain', phonetic: '|pleɪn|', az: 'sadə' },
      { en: 'ugly', phonetic: '|ˈʌɡlɪ|', az: 'çirkin' },
      { en: 'How tall are you?', phonetic: '|haʊ tɔːl ɑː jʊ|', az: 'Boyunuz nə qədərdir?' },
      { en: 'tall', phonetic: '|tɔːl|', az: 'hündür' },
      { en: 'short', phonetic: '|ʃɔːt|', az: 'qısa' },
      { en: 'medium height', phonetic: '|ˈmiːdɪəm haɪt|', az: 'ortaboylu' },
      { en: 'How heavy are you?', phonetic: '|haʊ ˈhevɪ ɑː jʊ|', az: 'Çəkiniz nə qədərdir?' },
      { en: 'weight', phonetic: '|weɪt|', az: 'çəki' },
      { en: 'thin', phonetic: '|θɪn|', az: 'arıq' },
      { en: 'skinny', phonetic: '|ˈskɪnɪ|', az: 'arıq, cılız' },
      { en: 'slim', phonetic: '|slɪm|', az: 'incə' },
      { en: 'fat', phonetic: '|fæt|', az: 'kök' },
      { en: 'overweight', phonetic: '|ˌəʊvəˈweɪt|', az: 'artıqçəkili' },
      { en: 'well-built', phonetic: '|ˈwelˈbɪlt|', az: 'gövdəli' },
      { en: 'put on weight', phonetic: '|ˈpʊt ɒn weɪt|', az: 'kökəlmək' },
      { en: 'gain weight', phonetic: '|ɡeɪn weɪt|', az: 'kökəlmək' },
      { en: 'lose weight', phonetic: '|luːz weɪt|', az: 'arıqlamaq' },
      { en: 'dark', phonetic: '|dɑːk|', az: 'tünd' },
      { en: 'blonde / blond', phonetic: '|blɒnd|', az: 'sarışın' },
      { en: 'fair', phonetic: '|feə|', az: 'ağbəniz' },
      { en: 'brunette', phonetic: '|bruːˈnet|', az: 'qaraşın' },
      { en: 'curly', phonetic: '|ˈkɜːlɪ|', az: 'buruq, qıvırcıq' },
      { en: 'straight', phonetic: '|streɪt|', az: 'düz' },
      { en: 'wavy', phonetic: '|ˈweɪvɪ|', az: 'dalğalı' },
      { en: 'haircut', phonetic: '|ˈheəkʌt|', az: 'saç kəsimi' },
      { en: 'shoulder-length hair', phonetic: '|ˈʃəʊldə leŋ(k)θ heə|', az: 'çiyin uzunluğunda saç' },
      { en: 'bald', phonetic: '|bɔːld|', az: 'keçəl' },
      { en: 'wig', phonetic: '|wɪɡ|', az: 'parik' },
      { en: 'hairstyle', phonetic: '|ˈheəstaɪl|', az: 'saç düzümü' },
      { en: 'braid', phonetic: '|breɪd|', az: 'hörük' },
      { en: 'skin', phonetic: '|skɪn|', az: 'dəri' },
      { en: 'moustache', phonetic: '|məˈstɑːʃ|', az: 'bığ' },
      { en: 'beard', phonetic: '|bɪəd|', az: 'saqqal' },
      { en: 'strong', phonetic: '|strɒŋ|', az: 'güclü' },
      { en: 'weak', phonetic: '|wiːk|', az: 'zəif' },
    ],
    'A1-Media': [
      { en: 'news', phonetic: '|njuːz|', az: 'xəbər' },
      { en: 'important', phonetic: '|ɪmˈpɔːt(ə)nt|', az: 'vacib' },
      { en: 'soap opera', phonetic: '|səʊp ˈɒp(ə)rə|', az: 'serial' },
      { en: 'story', phonetic: '|ˈstɔːrɪ|', az: 'hekayə' },
      { en: 'documentary', phonetic: '|dɒkjʊˈment(ə)rɪ|', az: 'sənədli film' },
      { en: 'public', phonetic: '|ˈpʌblɪk|', az: 'ictimai' },
      { en: 'cartoon', phonetic: '|kɑːˈtuːn|', az: 'cizgi filmi' },
      { en: 'reality', phonetic: '|rɪˈælɪtɪ|', az: 'həqiqət' },
      { en: 'magazine', phonetic: '|mæɡəˈziːn|', az: 'jurnal' },
      { en: 'interview', phonetic: '|ˈɪntəvjuː|', az: 'müsahibə' },
      { en: 'reporter', phonetic: '|rɪˈpɔːtə|', az: 'müxbir' },
      { en: 'journalist', phonetic: '|ˈdʒɜːn(ə)lɪst|', az: 'jurnalist' },
      { en: 'channel', phonetic: '|ˈtʃæn(ə)l|', az: 'kanal' },
      { en: 'What’s on?', phonetic: '|wɒt’z ɒn|', az: 'Nə gedir?' },
      { en: 'newspaper', phonetic: '|ˈnjuːzpeɪpə|', az: 'qazet' },
      { en: 'broadcast', phonetic: '|ˈbrɔːdkɑːst|', az: 'yayım' },
      { en: 'live', phonetic: '|ˈlaɪv|', az: 'canlı' },
      { en: 'breaking news', phonetic: '|ˈbreɪkɪŋ njuːz|', az: 'son xəbərlər' },
      { en: 'advertisement (ad)', phonetic: '|ədˈvɜːtɪzm(ə)nt|', az: 'reklam' },
      { en: 'article', phonetic: '|ˈɑːtɪk(ə)l|', az: 'məqalə' },
      { en: 'share', phonetic: '|ʃeə|', az: 'paylaşmaq' },
      { en: 'headline', phonetic: '|ˈhedlaɪn|', az: 'başlıq' },
      { en: 'viewer', phonetic: '|ˈvjuːə|', az: 'izləyici' },
      { en: 'listener', phonetic: '|ˈlɪs(ə)nə|', az: 'dinləyici' },
      { en: 'content', phonetic: '|kənˈtent|', az: 'məzmun' },
    ],
    'A1-Holiday': [
      { en: 'holiday', phonetic: '|ˈhɒlədeɪ|', az: 'tətil' },
      { en: 'journey', phonetic: '|ˈdʒɜːni|', az: 'səfər' },
      { en: 'vacation', phonetic: '|veɪˈkeɪʃən|', az: 'istirahət' },
      { en: 'voyage', phonetic: '|ˈvɔɪɪdʒ|', az: 'dəniz səfəri' },
      { en: 'on business', phonetic: '|ɒn ˈbɪznəs|', az: 'işgüzar' },
      { en: 'trip', phonetic: '|trɪp|', az: 'səyahət' },
      { en: 'travel', phonetic: '|ˈtrævəl|', az: 'səyahət' },
      { en: 'flight', phonetic: '|flaɪt|', az: 'uçuş' },
      { en: 'camp', phonetic: '|kæmp|', az: 'düşərgə' },
      { en: 'tent', phonetic: '|tɛnt|', az: 'çadır' },
      { en: 'plane', phonetic: '|pleɪn|', az: 'təyyarə' },
      { en: 'car', phonetic: '|kɑː|', az: 'avtomobil' },
      { en: 'bus', phonetic: '|bʌs|', az: 'avtobus' },
      { en: 'ferry', phonetic: '|ˈfɛri|', az: 'feribot' },
      { en: 'train', phonetic: '|treɪn|', az: 'qatar' },
      { en: 'passport', phonetic: '|ˈpɑːspɔːt|', az: 'pasport' },
      { en: 'ticket', phonetic: '|ˈtɪkɪt|', az: 'bilet' },
      { en: 'cheque', phonetic: '|ʧɛk|', az: 'çek' },
      { en: 'currency', phonetic: '|ˈkʌrənsi|', az: 'valyuta' },
      { en: 'luggage', phonetic: '|ˈlʌɡɪdʒ|', az: 'baqaj' },
      { en: 'suitcase', phonetic: '|ˈsuːtkeɪs|', az: 'çamadan' },
      { en: 'rucksack', phonetic: '|ˈrʌksæk|', az: 'bel çantas' },
      { en: 'local', phonetic: '|ˈləʊkəl|', az: 'yerli' },
      { en: 'enjoy', phonetic: '|ɪnˈdʒɔɪ|', az: 'zövq almaq' },
      { en: 'nightlife', phonetic: '|ˈnaɪtlaɪf|', az: 'gecə həyatı' },
      { en: 'move', phonetic: '|muːv|', az: 'hərəkət etmək; köçmək' },
      { en: 'have a rest', phonetic: '|hæv ə rɛst|', az: 'istirahət etmək' },
      { en: 'relax', phonetic: '|rɪˈlæks|', az: 'rahatlamaq' },
      { en: 'visit', phonetic: '|ˈvɪzɪt|', az: 'ziyarət etmək' },
      { en: 'explore', phonetic: '|ɪkˈsplɔː|', az: 'araşdırmaq' },
      { en: 'seashore', phonetic: '|ˈsiːʃɔː|', az: 'dəniz sahili' },
      { en: 'beach', phonetic: '|biːʧ|', az: 'çimərlik' },
      { en: 'airport', phonetic: '|ˈeəpɔːt|', az: 'hava limanı' },
      { en: 'stay at hotel', phonetic: '|steɪ æt həʊˈtɛl|', az: 'oteldə qalmaq' },
    ]      
